...
var i=b[c].events,j=i[e]||(i[e]=[]);return j.push({callback:f,context:g,ctx:g||b,name:e,node:h&&h.node}),d.test(e)&&a._defineSpecial(b,e.replace(d,"")),b},e=a._addListener=function(e,f,g,h,i){if(!e||"object"!=typeof e)return!1;b(e);var j,k,l,m,n=h||e,o=e[c].events,p=o[f]||(o[f]=[]),q=p.length,r=/([^\:\:]+)(::([^\(\)]+)?(\((.*)\))?)?/,s={callback:g,context:h,ctx:n,name:f};for(j=0;q>j;j++)if(k=p[j],(k.callback==g||k.callback==g._callback)&&k.context==h)return!1;if(i){l={};for(j in i)l[j]=i[j];for(j in s)l[j]=s[j]}else l=s;return p.push(l),m=r.exec(f),m&&m[2]?a._addDOMListener(e,m[3]||"sandbox",m[1],m[5],g,n,l):d.test(f)&&a._defineSpecial(e,f.replace(d,"")),a._fastTrigger(e,"addevent:"+f,l),a._fastTrigger(e,"addevent",l),!0}}(b,m,d,z),B=function(a,b){a._removeListener=function(c,d,e,f,g){if(!c||"object"!=typeof c||!c[b]||!c[b].events)return c;var h,i,j,k,l,m=c[b].events[d]||[],n=c[b].events[d]=[],o=/([^\:\:]+)(::([^\(\)]+)(\((.*)\))?)?/,p=0,q=m.length;if(g=g||{},j=o.exec(d),j&&j[2])a._removeDOMListener(c,j[3],j[1],j[5],e,f);else{

...
for(l in e)e.hasOwnProperty(l)&&d(b,l,e[l],f,g,h,i);return b}return"number"!=typeof g&&(j=i,i=h,h=g,g=0),k=c.debounce(f,g),k._callback=f,a.on(b,e,k,h,i,j)}}(b,m,c),J=function(a,b){return a.sym=b,a}(b,d),J.version="1.2.0",function(){"undefined"!=typeof a&&("function"==typeof define&&define.amd?(define("matreshka-magic",function(){return J}),define(function(){return J})):"object"==typeof exports?a.module.exports=J:a.magic=a.MatreshkaMagic=J)}()}(this);

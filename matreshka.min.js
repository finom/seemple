...
var f,g,h,j,k,l,m,n=typeof b,o=Number.isNaN||function(a){return"number"==typeof a&&isNaN(a)};if("undefined"==n)return a;if("object"==n){for(k in b)b.hasOwnProperty(k)&&d.set(a,k,b[k],c);return a}if(!a[i]||!a[i].special||!a[i].special[b])return a[b]=c,a;if(f=a[i].special[b],g=a[i].events,h=f.value,j=!f.mediator||c===h||e&&(e.skipMediator||e.fromMediator)?c:f.mediator(c,h,b,a),l={value:j,previousValue:h,key:b,node:f.$nodes[0]||null,$nodes:f.$nodes,self:a},e&&"object"==typeof e)for(k in e)l[k]=e[k];return m=(j!==h||l.force)&&!l.silent,m&&(g["beforechange:"+b]&&d._fastTrigger(a,"beforechange:"+b,l),g.beforechange&&d._fastTrigger(a,"beforechange",l)),f.value=j,(j!==h||l.force||l.forceHTML||j!==c&&!o(j))&&(l.silentHTML||g["_runbindings:"+b]&&d._fastTrigger(a,"_runbindings:"+b,l)),m&&(g["change:"+b]&&d._fastTrigger(a,"change:"+b,l),g.change&&d._fastTrigger(a,"change",l)),j===h&&!l.force&&!l.forceHTML||l.skipLinks||g["_rundependencies:"+b]&&d._fastTrigger(a,"_rundependencies:"+b,l),a},_parseBindings:function(a,c){

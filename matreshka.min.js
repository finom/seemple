...
b=0;d>b;b++)c[b]=a.call(c,c[b],b);return c},recreate:function(a,b){a=a||[];var d,e,f,h,j,k,l,m=this._initMK(),n=m.length-a.length,o=m.toArray();if(b=b||{},m._itemMediator&&!b.skipMediator){for(d=[],e=0;e<a.length;e++)d[e]=m._itemMediator.call(m,a[e],e);a=d}for(e=0;e<a.length;e++)m[e]=a[e];for(e=0;n>e;e++){try{delete m[e]}catch(p){}delete m[c].special[e]}if(m.length=a.length,b.silent&&b.dontRender)return m;if(l=m.toArray(),l.length)for(k=[],f=0,e=0;e<o.length;e++)~g.call(l,o[e])||(k[f++]=o[e]);else k=o;if(o.length)for(j=[],f=0,e=0;e<l.length;e++)~g.call(o,l[e])||(j[f++]=l[e]);else j=l;h={added:j,removed:k,was:o,now:l,method:"recreate",self:m};for(e in b)h[e]=b[e];return h.silent||i(m,h,"recreate"),m},toArray:function(){var a,b=this,c=[],d=b.length;for(c=[],a=0;d>a;a++)c[a]=b[a];return c},toNative:function(){return this.toArray()},_initMK:function(){var b,d=this;return d[c]?d:(b=function(){var a=d.Model;a&&d.mediateItem(function(b){return b&&b.isMK&&(b&&b.instanceOf?b.instanceOf(a):b instanceof a)?b:new a(b&&b.toJSON?b.toJSON():b,d);

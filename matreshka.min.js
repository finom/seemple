...
i.addone))for(f=0;f<g.length;f++)a._trigger(b,"addone",{self:b,added:g[f]});if(h.length&&(i.remove&&a._trigger(b,"remove",d),i.removeone))for(f=0;f<h.length;f++)a._trigger(b,"removeone",{self:b,removed:h[f]});(g.length||h.length)&&(i.modify&&a._trigger(b,"modify",d),d.dontRender||b.processRendering(d))},j=function(a,b){b=b||[];var c,d=a.length-b.length;for(c=0;c<b.length;c++)a[c]=b[c];for(c=0;d>c;c++)a.remove(c+b.length,{silent:!0});return a.length=b.length,a},k=function(c,f){var g,h;switch(c){case"forEach":return function(){var a=this;return b[c].apply(e?a.toArray():a,arguments),a};case"map":case"filter":case"slice":return function(){var d=this;return a.Array.from(b[c].apply(e?d.toArray():d,arguments))};case"every":case"some":case"reduce":case"reduceRight":case"toString":case"join":return function(){var a=this;return b[c].apply(e?a.toArray():a,arguments)};case"sort":case"reverse":return function(){var a=this._initMK(),k=arguments,l=d(k),m=f?k[k.length-1]||{}:{},n=a.toArray(),o=b[c].apply(n,l);
f&&l.pop(),e?(n=a.toArray(),o=b[c].apply(n,l),j(a,n)):o=b[c].apply(a,l),h={returns:o,args:l,originalArgs:k,method:c,self:a,added:[],removed:[]};for(g in m)h[g]=m[g];return h.silent||i(a,h,c),a};case"pop":case"shift":return function(){if(this.length){var a,k,l,m,n=this._initMK(),o=arguments,p=d(o),q=f?o[o.length-1]||{}:{};f&&p.pop(),e?(a=n.toArray(),k=b[c].apply(a,p),j(n,a)):k=b[c].apply(n,p),h={returns:k,args:p,originalArgs:o,method:c,self:n,added:l="push"==c||"unshift"==c?p:[],removed:m="pop"==c||"shift"==c?[k]:[]};for(g in q)h[g]=q[g];return h.silent||i(n,h,c),k}};case"push":case"unshift":return function(){var a,k,l,m,n=this._initMK(),o=arguments,p=d(o),q=f?o[o.length-1]||{}:{};if(f&&p.pop(),!p.length)return n.length;if(!q.skipMediator&&"function"==typeof n._itemMediator)for(g=0;g<p.length;g++)p[g]=n._itemMediator.call(n,p[g],g);e?(a=n.toArray(),k=b[c].apply(a,p),j(n,a)):k=b[c].apply(n,p),h={returns:k,args:p,originalArgs:o,method:c,self:n,added:l="push"==c||"unshift"==c?p:[],removed:m="pop"==c||"shift"==c?[k]:[]
};for(g in q)h[g]=q[g];return h.silent||i(n,h,c),k};case"splice":return function(){var k,l,m,n=this._initMK(),o=arguments,p=d(o),q=f?o[o.length-1]||{}:{},r=d(p,2);if(f&&p.pop(),!q.skipMediator&&"function"==typeof n._itemMediator)for(g=2;g<p.length;g++)p[g]=n._itemMediator.call(n,p[g],g);if(e?(k=n.toArray(),l=b[c].apply(k,p),j(n,k)):l=b[c].apply(n,p),m=l,r.length||m.length){h={returns:l,args:p,originalArgs:o,method:c,self:n,added:r,removed:m};for(g in q)h[g]=q[g];h.silent||i(n,h,c)}return a.Array.from(l)}}},l={"extends":a,isMKArray:!0,length:0,itemRenderer:null,renderIfPossible:!0,useBindingsParser:!1,Model:null,constructor:function MatreshkaArray(a){var b,c=this._initMK(),d=arguments.length;if(1==d&&"number"==typeof a)c.length=a;else{for(b=0;d>b;b++)c[b]=arguments[b];c.length=arguments.length}},mediateItem:function(a){var b,c=this,d=c.length;for(c._itemMediator=a,b=0;d>b;b++)c[b]=a.call(c,c[b],b);return c},recreate:function(a,b){a=a||[];var c,d,e,f,h,j,k,l=this._initMK(),m=l.length-a.length,n=l.toArray();
if(b=b||{},l._itemMediator&&!b.skipMediator){for(c=[],d=0;d<a.length;d++)c[d]=l._itemMediator.call(l,a[d],d);a=c}for(d=0;d<a.length;d++)l[d]=a[d];for(d=0;m>d;d++)l.remove(d+a.length,{silent:!0});if(l.length=a.length,b.silent&&b.dontRender)return l;if(k=l.toArray(),k.length)for(j=[],e=0,d=0;d<n.length;d++)~g.call(k,n[d])||(j[e++]=n[d]);else j=n;if(n.length)for(h=[],e=0,d=0;d<k.length;d++)~g.call(n,k[d])||(h[e++]=k[d]);else h=k;f={added:h,removed:j,was:n,now:k,method:"recreate",self:l};for(d in b)f[d]=b[d];return f.silent||i(l,f,"recreate"),l},toArray:function(){var a,b=this,c=[],d=b.length;for(c=[],a=0;d>a;a++)c[a]=b[a];return c},toNative:function(){return this.toArray()},_initMK:function(){var b,d=this;return d[c]?d:(b=function(){var a=d.Model;a&&d.mediateItem(function(b){return b&&b.isMK&&(b&&b.instanceOf?b.instanceOf(a):b instanceof a)?b:new a(b&&b.toJSON?b.toJSON():b,d)})},a.prototype._initMK.call(d),a._addListener(d,"change:Model",b),b(),d)},_renderOne:function(b,d){var e,f,g=this,h=g[c].id,i=b.renderer||g.itemRenderer,j=i===b.renderer?b:g,k=b[c].arraysNodes=b[c].arraysNodes||{},l=k[h];
if(d.moveSandbox&&(l=b.bound(["sandbox"]))&&(k[h]=l),!l){if("function"==typeof i&&(i=i.call(j,b)),"string"!=typeof i||/<|{{/.test(i))f=i;else{if(f=j._getNodes(i),!(f=f&&f[0]))throw Error("renderer node is missing: "+i);f=f.innerHTML}e=g.useBindingsParser?a._parseBindings(b,f):"string"==typeof f?a.$.parseHTML(f.replace(/^\s+|\s+$/g,"")):a.$(f),b.bindRenderedAsSandbox!==!1&&e.length&&a.bindNode(b,"sandbox",e),l=e[0],k[h]=l,a._trigger(b,"render",{node:l,$nodes:e,self:b,parentArray:g})}return l},processRendering:function(a){var b,d,e,f=this,g=f[c],h=g.id,i=f.length,j=function(a){var d;return a&&a.isMK?((d=a[c].arraysNodes)&&(b=d[h],delete d[h]),b):void 0},k=function(b){return b&&b.isMK&&f.renderIfPossible&&l&&!a.dontRender&&(f.itemRenderer||b.renderer)&&f._renderOne(b,a)},l=g.special.container||g.special.sandbox;switch(l=l&&l.$nodes,l=l&&l[0],a.method){case"push":for(d=i-a.added.length;i>d;d++)(b=k(f[d]))&&l.appendChild(b);break;case"unshift":for(d=a.added.length-1;d+1;d--)(b=k(f[d]))&&(l.children?l.insertBefore(b,l.firstChild):l.appendChild(b));
break;case"pull":case"pop":case"shift":for(d=0;d<a.removed.length;d++)(b=j(a.removed[d]))&&l.removeChild(b);break;case"sort":case"reverse":for(d=0;i>d;d++)e=f[d],(b=e&&e.isMK&&e.bound([h]))&&l.appendChild(b);break;case"rerender":for(d=0;i>d;d++)(b=k(f[d]))&&l.appendChild(b);break;case"recreate":case"splice":for(d=0;d<a.removed.length;d++)(b=j(a.removed[d]))&&l.removeChild(b);for(d=0;i>d;d++)(b=k(f[d]))&&l.appendChild(b)}return f},rerender:function(){return this.processRendering({method:"rerender"})},hasOwnProperty:function(a){return"length"==a||a<this.length&&a>=0},toJSON:function(){var a,b=this,c=[],d=b.length;for(a=0;d>a;a++)b[a]&&b[a].toJSON?c.push(b[a].toJSON()):c.push(b[a]);return c},concat:function(){var b,c,d,e=arguments,f=this.toArray();for(c=0;c<e.length;c++)if(b=e[c],b instanceof Array||b&&b.instanceOf&&b.instanceOf(a.Array))for(d=0;d<b.length;d++)f.push(b[d]);return a.Array.from(f)},pull:function(a,b){var c,d,e,g,h=this._initMK(),k=h.toArray(),l=a,m=typeof a;if("number"!=m&&"string"!=m&&(a=h.indexOf(a),
!~a))return null;if(c=k.splice(a,1)[0]||null,!f(k,h)){b=b||{},j(h,k,b),e={returns:c,args:[l],method:"pull",self:h,added:[],removed:d=c?[c]:[]};for(g in b)e[g]=b[g];e.silent||i(h,e,"pull")}return c},indexOf:g,lastIndexOf:h};return"push pop unshift shift sort reverse splice map filter slice every some reduce reduceRight forEach toString join".split(" ").forEach(function(a){l[a]=k(a)}),"push pop unshift shift sort reverse splice".split(" ").forEach(function(a){l[a+"_"]=k(a,1)}),l.each=l.forEach,l["undefined"!=typeof Symbol?Symbol.iterator:"@@iterator"]=function(){var a=this,b=0;return{next:function(){return b>a.length-1?{done:!0}:{done:!1,value:a[b++]}}}},a.Array=a.Class(l),a.Array.of=function(){var b,c=new a.Array,d=arguments;for(c.length=d.length,b=0;b<d.length;b++)c[b]=d[b];return c},a.Array.from=function(b,c,d){var e,f=new a.Array;for(f.length=b.length,e=0;e<b.length;e++)f[e]=c?c.call(d,b[e],e,b):b[e];return f},a.Array}),"function"==typeof define&&define.amd&&define("matreshka",["matreshka_dir/matreshka-core","matreshka_dir/matreshka-object","matreshka_dir/matreshka-array"],function(a,b,c,d){
return a}),"function"==typeof define&&define.amd?define(["matreshka"],function(a){return a.version="1.1.0-alpha.1",a}):(Matreshka.version="1.1.0-alpha.1","object"==typeof exports&&(module.exports=Matreshka));

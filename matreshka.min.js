...
})}),e},remove:function(a,b,c){if(!a||"object"!=typeof a)return null;var e,f,g=String(b).split(/\s/),h={keys:g};if(c&&"object"==typeof c)for(f in c)h[f]=c[f];for(f=0;f<g.length;f++)if(b=g[f],e=b in a){h.key=b,h.value=a[b];try{delete a[b]}catch(j){}a[i]&&(d.unbindNode(a,b),d.off(a,"change:"+b+" beforechange:"+b+" _runbindings:"+b+" _rundependencies:"+b),delete a[i].special[b],h.silent||(d._fastTrigger(a,"delete",h),d._fastTrigger(a,"delete:"+b,h)))}return a},_getNodes:function(a,c){return"string"==typeof c&&!/</.test(c)&&/:sandbox|:bound\(([^(]*)\)/.test(c)?k(a,c):b(c)},define:function(a,b,c){if(!a||"object"!=typeof a)return a;var e;if("object"==typeof b){for(e in b)d.define(a,e,b[e]);return a}return Object.defineProperty(a,b,c),a},defineGetter:function(a,b,c){if(!a||"object"!=typeof a)return a;j(a);var e,f;if("object"==typeof b){for(e in b)b.hasOwnProperty(e)&&d.defineGetter(a,e,b[e]);return a}return f=d._defineSpecial(a,b),f.getter=function(){return c.call(a,{value:f.value,key:b,self:a
